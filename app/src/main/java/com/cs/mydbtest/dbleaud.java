...
public class dbleaud {
    public static String executeQuery(String emp_id,String reason,String lea_id,String notes,String manager,String mylog) {
        String result = "";
       
        try { 
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("https://demo.chansing.com.tw/off2/leaudapp.php");
