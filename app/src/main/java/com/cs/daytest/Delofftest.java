...
import com.cs.mydbtest.dbleadel;
import com.cs.mydbtest.dbleasel;
import com.cs.mydbtest.dbleaud;
...
public class Delofftest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delofftest);
    ...
    private void refresh() {
        //finish();
        Intent intent = new Intent(Delofftest.this, Delofftest.class);
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch(motionEvent.getAction()){
                ...
                case  MotionEvent.ACTION_UP:
                    ...
                    Intent intent = new Intent(Delofftest.this, Mymenutest.class);
                    startActivity(intent);
                    break;
            }
            return true;
    ...
    {
        Toast toast=Toast.makeText(Delofftest.this, str, Toast.LENGTH_LONG);
    ...
    public void onBackPressed() {
        ...
        intent.setClass(Delofftest.this,Mymenutest.class);
        startActivity(intent);
    }
