...
import com.cs.mydbtest.dbleave2;
...
public class Subsigntest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subsigntest);
    ...
    private void startDownload() {
        ...
        new Subsigntest.DownloadFileAsync().execute();
    }
    class DownloadFileAsync extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Subsigntest.this);
    ...
    private void refresh() {
        //finish();
        Intent intent = new Intent(Subsigntest.this, Subsigntest.class);
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch(motionEvent.getAction()){
                ...
                case  MotionEvent.ACTION_UP:
                    ...
                    Intent intent = new Intent(Subsigntest.this, Mymenutest.class);
                    startActivity(intent);
                    break;
            }
            return true;
    ...
    public void onBackPressed() {
        ...
        intent.setClass(Subsigntest.this,Mymenutest.class);
        startActivity(intent);
    }
