...
import com.cs.mydbtest.dbleave2man;
...
public class Checktest extends AppCompatActivity {
    ...
    private void startDownload() {
        ...
        new Checktest.DownloadFileAsync().execute();
    }
    class DownloadFileAsync extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Checktest.this);
    ...
    private void refresh() {
        //finish();
        Intent intent = new Intent(Checktest.this, Checktest.class);
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch(motionEvent.getAction()){
                ...
                case  MotionEvent.ACTION_UP:
                    ...
                    Intent intent = new Intent(Checktest.this, Mymenutest.class);
                    startActivity(intent);
                    break;
            }
            return true;
    ...
    public void onBackPressed() {
        ...
        intent.setClass(Checktest.this,Mymenutest.class);
        startActivity(intent);
    }
