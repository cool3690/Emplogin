...
public class Off extends AppCompatActivity {
    ...
    private void startDownload() {
        ...
        new Off.DownloadFileAsync().execute();
    }
    ...
    public void search() {
        try {
            ...
            String result = com.cs.mydb.dbcheck.executeQuery(account);
            ...
            switch (motionEvent.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (TextUtils.isEmpty(time1.getText().toString()) || TextUtils.isEmpty(time2.getText().toString())) {
                        ...
                        for (int y = 0; y < 1; y++) {
                            try {
                                String tim = time1.getText().toString();
                            ...
                            if (Integer.parseInt(t1[0]) < 12 && Integer.parseInt(t2[0]) > 13) {
                                count = count - 60;
                            }
                            if (count > 480) {
                                count = 480;
    ...
    private void showDatePickerDialog() {
        ...
        new DatePickerDialog(Off.this, R.style.DatePickBackgroundColor, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                if (monthOfYear < 10) {
                    tmp = "0" + monthOfYear;
                } else tmp = "" + monthOfYear;
                if (dayOfMonth < 10) {
                    tmp2 = "0" + dayOfMonth;
                } else tmp2 = "" + dayOfMonth;
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch (motionEvent.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    Intent intent = new Intent(Off.this, Mymenu.class);
